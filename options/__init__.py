...
class BaseOptions():
    def initialize(self, parser):
        ...
        parser.add_argument('--optimizer', type=str, default='ours', help='which model to use')
        ...
        parser.add_argument('--fake_dir', type=str, default="fake")
        parser.add_argument('--match', type=str, default="tools/match.csv")
